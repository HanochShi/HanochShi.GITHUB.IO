...
ad_click(l,c,u,g,_,y,D,n,v,d,s,o,h,E,i,r,p,f,P),log("[Ad] ad_click: type="+l+", url="+c+", rl="+u+", apurl="+g+", traceid="+_+", ticket="+y+", group_id="+D+", aid="+n+", pt="+v+", pos_type="+d+", ad_engine="+s);
}
...
return ad_click(i,n,_,l,c,m,f,g,y,d,s,o,w,O,T,h,p,v,D),log("[Ad] ad_click: type="+i+", url="+n+", rl="+_+", apurl="+l+", traceid="+c+", ticket="+m+", group_id="+f+", aid="+g+", pt="+y+", pos_type="+d+", ad_engine="+s),
hideComplainBtns(),!1;
});
