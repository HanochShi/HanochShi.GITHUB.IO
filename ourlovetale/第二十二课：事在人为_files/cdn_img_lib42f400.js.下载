...
p.device.inWechat&&p.device.inWindowWechat?window.__addIdKeyReport("110644",0):p.device.inWechat&&p.device.inMacWechat&&window.__addIdKeyReport("110644",1));
}
...
m.innerHTML=k.tmpl(g,t[_]);
{
var l=m.children[0],p=s.parentNode,c=p.insertBefore(l,s),w=c.children[0];
(function(e,t){
...
if(!(a&&n&&s&&_))return;
var p,c,w=e("appmsg/like.js");
1==appmsg_like_type?(p=o,c=d):(p=n,c=s),i.liked=window.is_temp_url?window.liked:i.liked,
w.showReadNum({
show:!0,
readAreaDom:a,
readNumDom:_,
...
t.share_redirect_url&&g&&(window._share_redirect_url=t.share_redirect_url,g.innerHTML=k.tmpl(h,{
url:t.share_redirect_url
})),l.initCommentByExtData(t),x.setBackgroundClass(),m.init(t.reward,{
...
e("biz_common/utils/string/html.js");
var m=e("appmsg/reward_utils.js"),l=e("appmsg/comment_utils.js"),p=e("pages/create_txv.js"),c=e("pages/video_ctrl.js"),w=e("biz_common/utils/url/parse.js"),g=e("appmsg/img_copyright_tpl.html.js"),u=e("appmsg/appmsgext.js"),h=e("appmsg/share_tpl.html.js"),y=navigator.userAgent,v=-1!=y.indexOf("MicroMessenger"),f=(-1!=navigator.userAgent.indexOf("WindowsWechat"),
